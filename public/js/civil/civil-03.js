...
// for matrics and calculus credit points is 3
...
//  div 6 
// credit points for Surveying and Levelling 3
...
//  div 7
// credit points for Surveying and Levelling Laboratory 1.5
...
//  div 8 
// credit points for Water and Wastewater Analysis Laboratory 1.5
...
//  div 9
// credit points for english lab  1
...
function div9() {
    ...
    const r8 = document.getElementById("res7").innerHTML;
    ...
    const add9 =parseInt(r9 + arrear9);
           ...
           const re2 = parseInt(r2);
            ...
            const divide = adding/24;  // credit points for 24
            console.log(divide);
