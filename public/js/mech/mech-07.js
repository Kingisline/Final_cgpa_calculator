...
// for Heat and Mass Transfer is 3
function div1() {
...
// Computer Integrated Manufacturing  is 3
...
// function div 4
// credit point for Industrial Managementis 3
...
//  div 5 
// credit points forOpen Elective – II is 3
...
// credit points for Mechatronics and IoT Laboratory2
...
function div8() {
    ...
    B.addEventListener('change', function () {
     ...
     c.addEventListener('change', function () {
        ...
        //  div 9
// credit points for //  div 9
// credit points for Summer Internship 1
...
function div9() {
    ...
    const arr9 = parseInt(arrear9)
           ...
           const re2 = parseInt(r2);
            ...
            const arre = arr1 + arr2 + arr3 + arr4 + arr5 + arr6 + arr6 + arr7 + add8 +add9;
            console.log(arre);
            const di  = parseInt(adding);
            const divide = adding/23;  // credit is 23
            console.log(divide);
