...
// for Object Oriented Software Engineering is 4
function div1() {
...
// function div 4
// credit point for Professional Elective III 3
...
//  div 5 
// credit points for Professional Elective IV 3
...
function div7() {
    ...
    const r7 = document.getElementById("res7").innerHTML;
            ...
            // //  console.log(ele);
            // })  
            const ad1 = parseFloat(inputs[0]); 
            const ad2 = parseFloat(inputs[1]); 
            const ad3 = parseFloat(inputs[2]); 
            const ad4 = parseFloat(inputs[3]); 
            const ad5 = parseFloat(inputs[4]); 
            const ad6 = parseFloat(inputs[5]); 
            const ad7 = parseFloat(inputs[6]); 
            ...
            // console.log(result_7)
                ...
                const cred_adding = (cre1 + cre2 + cre3 + cre4 + cre5 + cre6);
