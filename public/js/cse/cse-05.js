...
// div 3 and input
// credit points for Cryptography  3
...
// function div 4
// credit point for Distributed Computingis 3
...
function div6() {
    ...
    const r6 = document.getElementById("res6").innerHTML;
            ...
            // console.log(result_6);
                                  ...
                                  const cred_loop = [cre1,cre2,cre3,cre4,cre5,cre6]
                                  //   console.log(inputs)
                                  ...
                                  const cred_data_result = [cred1,cred2,cred3,cred4,cred5,cred6];
                                  ...
                                  const final_cred_result = (cred_result_1+ cred_result_2+ cred_result_3+ cred_result_4+ cred_result_5+ cred_result_6)
